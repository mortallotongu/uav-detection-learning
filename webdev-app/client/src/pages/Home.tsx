...
const HERO_IMAGE = import.meta.env.VITE_GITHUB_PAGES === "true" ? `${import.meta.env.BASE_URL}assets/dfine-hero.webp` : (import.meta.env.VITE_HERO_IMAGE || "/manus-storage/dfine-hero_66e65263.png");
    ...
    <div className="layout">
      ...
      <main className="content-area">
        <div className="content-wrap">
          ...
          <ReviewPanel />
          <section className="glossary-section" id="glossary"><div className="glossary-heading"><div><span className="eyebrow">SMALL INDEX</span><h2>一组词，反复回来查。</h2></div><span>术语不是终点，机制才是。按它们之间的关系回看。</span></div><div className="glossary-grid">{glossary.map(([term, description]) => <div className="glossary-item" key={term}><span>{term}</span><p>{description}</p></div>)}</div></section>
